...
crfoutput = inference.crf("inp.png", "pred.png", "output.png", 23, use_2d=True)
...
gtimage = misc.imread("gt.png")
print(gtimage.shape)
print(np.unique(gtimage))
crossmat = _calcCrossMat(gtimage, crfoutput.astype(np.uint8), 23)
print(crossmat)
print(_calc_eval_metrics(gtimage, crfoutput.astype(np.uint8), 23))
